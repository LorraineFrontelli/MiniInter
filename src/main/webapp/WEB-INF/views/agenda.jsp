    ...
    <header class="headerLateral">
        ...
        <nav>
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/boletim.jsp" class="pagina"><img src="${pageContext.request.contextPath}/assets/img/grades-icon.svg" decoding="async" alt="">Notas</a></li>

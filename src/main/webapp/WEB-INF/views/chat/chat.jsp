...
<body>
    <main>
        ...
        <section class="fundoChat">
            <ul class="conversa">
                ...
                <li class="mensagem prof">
                    <p>A média da minha disciplina foi formada a partir das 
                       notas das avaliações e do projeto interdisciplinar.</p>
                </li>
                <li class="mensagem aluno">
            ...
            <form class="barraMensagem" action="EnviarMensagemServlet" method="POST">
                <input type="text" name="mensagem" id="mensagem" class="escreverMensagem" placeholder="Digite sua mensagem...">

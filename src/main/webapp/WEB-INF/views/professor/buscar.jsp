    ...
    <header class="headerLateral">
        ...
        <nav>
            <ul>
                ...
                <li><a href="buscar.html" class="pagina ativo"><img src="${pageContext.request.contextPath}assets/img/search-icon.svg" decoding="async" alt="">Buscar</a></li>
    ...
    <main>
        <div class="cabecalhoPaginas">
            ...
            <div class="buscarAlunos">
                <search>
                    <form action="">
                        <input type="text" class="buscar" placeholder="Inserir matrícula">
                    </form>
                </search>
        ...
        <div class="buscaContainer">
            <div class="resultadoBusca">
                <div>
                    <strong>Aluno: Tainá Dias Martinelli</strong>
                    <br>
                    <span><b>Matrícula:</b> 12345678</span>
                </div>
                <a href="notas.html"><img src="${pageContext.request.contextPath}assets/img/see-more-icon.svg" alt=""></a>
            </div>
        </div>
    </main>
</body>

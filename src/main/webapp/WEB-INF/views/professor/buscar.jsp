    ...
    <header class="headerLateral">
        ...
        <nav>
            <ul>
                ...
                <li><a href="buscar.jsp" class="pagina ativo"><img src="${pageContext.request.contextPath}assets/img/search-icon.svg" decoding="async" alt="">Buscar</a></li>
    ...
    <main>
        ...
        <div class="buscaContainer">
            <div class="resultadoBusca">
                ...
                <a href="notas.jsp"><img src="${pageContext.request.contextPath}assets/img/see-more-icon.svg" alt=""></a>
            </div>
        </div>
    </main>
</body>

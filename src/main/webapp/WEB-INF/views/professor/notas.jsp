    ...
    <header class="headerLateral">
        ...
        <nav>
            <ul>
                ...
                <li><a href="buscar.html" class="pagina"><img src="${pageContext.request.contextPath}/assets/img/search-icon.svg" decoding="async" alt="">Buscar</a></li>
    ...
    <main>
        ...
        <section class="notasAluno">
            ...
            <form action="">
                ...
                <div class="menuAluno">
                    <button type="button" onclick="window.location.href='buscar.html'">Voltar</button>
